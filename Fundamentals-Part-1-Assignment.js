//  EXERCISE ONE - troubleshooting.js
/**
 * ===== Troubleshooting =====
...
/*
  REPLIT CONSOLE OUTPUT: 
  Test Results: 
  If I enter 2, the result is false. This is correct!
  If I enter 12, the result is true. This is correct!
  If I enter 6, the result is false. This is correct!
  If I enter 10, the result is true. This is correct!
  If I enter 9, the result is false. This is correct!
  You've passed all the tests, continue to the next lesson!
*/

//  EXERCISE THREE - math.js
/**
 * Lets do some math!
 * Some rules first:
...
/*
REPLIT CONSOLE OUTPUT:
'a' is incorrect, got 1 + 8, expected 9
'b' is incorrect, got 22 * 3, expected 66
'c' is incorrect, got 5 % 4, expected 1
'd' is incorrect, got a - 17, expected -8
'e' is incorrect, got a + b + c + d, expected 68
*/

//  EXERCISE FOUR - follow.js
/**
